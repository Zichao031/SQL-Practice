...
--2. exclude the rows that listPrice is zero
SELECT ProductID, Name, Color, ListPrice
FROM Production.Product
WHERE ListPrice <> 0
...
--5. color is null and ListPrice > 0
SELECT ProductID, Name, Color, ListPrice
FROM Production.Product
WHERE Color is NOT NULL AND ListPrice > 0

--6. Write a query that concatenates the columns Name and Color from the Production.Product table by 
...
SELECT 'NAME: ' + Name + '  --  COLOR: ' + Color AS Results
FROM Production.Product
WHERE Color IS NOT NULL
